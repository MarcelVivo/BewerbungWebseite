...
const PROJEKTTYPEN: { label: string; icon: LucideIcon; desc: string }[] = [
  ...
  { label: 'App / Plattform',     icon: Smartphone,    desc: 'Ich entwickle eine Software, die zu deinem Ablauf passt.' },
...
const EN_TEXT: Record<string, string> = {
  ...
  'App / Plattform': 'App / Platform', 'Ich entwickle eine Software, die zu deinem Ablauf passt.': 'I develop software that fits your process.',
  ...
  "Unter CHF 2'000": "Under CHF 2,000", "CHF 2'000 bis 5'000": 'CHF 2,000 to 5,000',
  "CHF 5'000 bis 15'000": 'CHF 5,000 to 15,000', "CHF 15'000 bis 30'000": 'CHF 15,000 to 30,000',
  "Über CHF 30'000": 'Over CHF 30,000', 'Noch nicht definiert': 'Not defined yet',
  'So bald wie möglich': 'As soon as possible', '1 bis 2 Monate': '1 to 2 months', '3 bis 6 Monate': '3 to 6 months',
  '6 bis 12 Monate': '6 to 12 months', 'Noch offen': 'Still open',
};

const UI = {
  de: {
    pageTitle: 'Projektanfrage | Digitalstudio Marcel Spahr', kicker: 'PERSÖNLICH. STRUKTURIERT. UNVERBINDLICH.',
    title: 'Erzähl mir von deinem Projekt.', intro: 'Beantworte ein paar Fragen. Ich lese deine Angaben selbst und melde mich innerhalb von zwei Arbeitstagen bei dir.',
    ...
    must: 'Ein Klick bedeutet, dass es dabei sein muss.', nice: 'Zwei Klicks bedeuten, dass es wünschenswert ist.', remove: 'Mit drei Klicks entfernst du den Eintrag.', custom: 'Füge eine eigene Anforderung hinzu.',
    ...
    more: 'Weitere Informationen (optional)', morePlaceholder: 'Nenne Besonderheiten, offene Fragen oder Wünsche.',
    promiseLead: 'So geht es weiter.', promise: 'Ich lese deine Anfrage selbst und melde mich innerhalb von zwei Arbeitstagen bei dir. Danach besprechen wir offen, was für dein Projekt sinnvoll ist.',
    ...
    back: 'Zurück', next: 'Weiter', send: 'Anfrage absenden', sending: 'Ich sende deine Anfrage.',
    ...
    nextItems: ['Ich lese deine Anforderungen sorgfältig.', 'Ich melde mich innerhalb von zwei Arbeitstagen bei dir.', 'Wir besprechen dein Projekt und die nächsten Schritte.'],
  ...
  en: {
    ...
    title: 'Tell me about your project.', intro: 'Answer a few questions. I will read your information myself and contact you within two business days.',
    ...
    must: 'One click means that it must be included.', nice: 'Two clicks mean that it would be useful.', remove: 'Three clicks remove the entry.', custom: 'Add your own requirement.',
    ...
    more: 'Additional information (optional)', morePlaceholder: 'Mention any special points, open questions or requests.',
    promiseLead: 'This is what happens next.', promise: 'I will read your enquiry myself and contact you within two business days. We will then discuss honestly what makes sense for your project.',
    ...
    back: 'Back', next: 'Next', send: 'Submit inquiry', sending: 'I am sending your enquiry.',
    ...
    nextItems: ['I read your requirements carefully.', 'I contact you within two business days.', 'We discuss your project and the next steps.'],
