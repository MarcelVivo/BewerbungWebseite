...
const STEPS: QuizStep[] = [
  ...
  },
  {
    ...
    options: [
      ...
      'Mehr Aufträge mit dem bestehenden Team bewältigen',
...
const KI_EN: Record<string, string> = {
  ...
  'Gar nichts. Wir sind startklar.': 'Nothing is holding us back. We are ready to start.', 'Wir wissen nicht, wo wir anfangen sollen': 'We do not know where to start',
  ...
  'Mehr Aufträge mit dem bestehenden Team bewältigen': 'Handle more orders with the existing team', 'Mitarbeitende entlasten': 'Reduce employee workload',
};

const KI_UI = {
  de: {
    title: 'KI-Check | Digitalstudio Marcel Spahr', badge: 'KOSTENLOS. PERSÖNLICH. OHNE VERKAUFSGESPRÄCH.',
    headingA: 'Wie KI-ready ist', headingB: 'dein', headingC: 'Unternehmen?', introA: 'Zehn Fragen. Drei Minuten.',
    introB: 'Du erhältst meine ehrliche Einschätzung.', introC: 'Ich sende dir meine Empfehlungen kostenlos per E-Mail.',
    start: 'Check starten', questions: 'Fragen', minutes: 'Minuten', result: 'Ergebnis', immediate: 'Sofort', home: 'Zurück zur Startseite',
    successTitle: 'Deine Antworten sind bei mir.', success: 'Ich prüfe deine Angaben selbst und melde mich innerhalb von zwei Arbeitstagen bei dir. Du erhältst eine konkrete Einschätzung von mir, Marcel Spahr.',
    ...
    formIntro: 'Ich prüfe deine Antworten selbst und sende dir Empfehlungen, die zu deinem Unternehmen passen.',
    name: 'Dein Name', company: 'Firmenname', phone: 'Telefon (optional)', sending: 'Ich sende deine Angaben.', submit: 'Meine Einschätzung erhalten',
  ...
  en: {
    title: 'AI Readiness Check | Marcel Spahr Digital Studio', badge: 'FREE. PERSONAL. NO SALES CALL.',
    headingA: 'How AI-ready is', headingB: 'your', headingC: 'business?', introA: 'Ten questions. Three minutes.',
    introB: 'You receive my honest assessment.', introC: 'I send you my recommendations by email at no cost.',
    start: 'Start check', questions: 'Questions', minutes: 'Minutes', result: 'Result', immediate: 'Instant', home: 'Back to homepage',
    successTitle: 'I have received your answers.', success: 'I will review your information myself and contact you within two business days. You will receive a practical assessment from me, Marcel Spahr.',
    ...
    formIntro: 'I review your answers myself and send you recommendations that fit your business.',
    name: 'Your name', company: 'Company name', phone: 'Phone (optional)', sending: 'I am sending your information.', submit: 'Receive my assessment',
